    ...
    <div className="relative h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-screen bg-black/30">
        <div className="text-center space-y-8 max-w-5xl px-12 md:px-24 lg:px-36 xl:px-48 mx-auto">
          ...
          {fullShortUrl && (
            <div className="flex items-center justify-between w-full max-w-2xl mx-auto p-4 bg-white/10 backdrop-blur rounded-xl animate-in fade-in slide-in-from-left-8 duration-1500">
